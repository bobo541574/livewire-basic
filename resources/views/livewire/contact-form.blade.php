<div>
    <main class="overflow-hidden">
        ...
        <!-- Contact section -->
        <section class="relative bg-gray-200" aria-labelledby="contact-heading">
                ...
                <div class="relative bg-white shadow-xl">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3">
                        ...
                        <div
                            ...
                            <p class="mt-6 text-base text-teal-50 max-w-3xl">Nullam risus blandit ac aliquam justo
                            ...
                            <dl class="mt-8 space-y-6">
                                ...
                                <dd class="flex text-base text-teal-50">
                                    ...
                                    <svg class="flex-shrink-0 w-6 h-6 text-teal-200"
                        ...
                        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                            ...
                            <form wire:submit.prevent="submitForm" method="POST"
                                ...
                                <div class="col-span-2">
                                    <label for="name" class="block text-sm font-medium text-warm-gray-900">Full
                                        name</label>
                                    <div class="mt-1">
                                        <input type="text" wire:model.debounce.500ms="state.name" name="name"
                                            id="name" autocomplete="given-name"
                                            class="py-2 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border-warm-gray-300 rounded-md">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <input id="email" type="email" wire:model.debounce.500ms="state.email"
                                ...
                                <div class="col-span-2">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" wire:model.debounce.500ms="state.phone" name="phone"
                                ...
                                <div class="col-span-2">
                                    <div class="flex justify-between">
                                        ...
                                        <span id="message-max" class="text-sm text-warm-gray-500">Max. 500
                                            characters</span>
                                    </div>
                                    <div class="mt-1">
                                        <textarea id="message" wire:model.debounce.500ms="state.message" name="message" rows="4"
                                            class="py-2 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-teal-500 focus:border-teal-500 border border-warm-gray-300 rounded-md"
                                ...
                                <div class="sm:col-span-2 sm:flex sm:justify-end">
                                    <button type="submit"
                                        class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:w-auto text-white bg-teal-500 hover:bg-teal-600 disabled:opacity-50"
                                        :disabled="{{ !$this->loaded['submit'] }}">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
